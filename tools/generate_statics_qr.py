"""Generate the Équilibre et rotation QR in the common PHYS1985 format.

Requires ReportLab and Pillow. No network access or changes to existing QR codes.
"""
...
svg = ET.Element("svg", xmlns="http://www.w3.org/2000/svg",
                 viewBox=f"0 0 {side} {side}", **{
                     ...
                     "aria-label": "QR code vers l’animation Équilibre et rotation"})
